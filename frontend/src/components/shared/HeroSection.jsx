...
const HeroSection = () => (
  <section
    className="relative min-h-screen overflow-hidden bg-[#1a0009] bg-cover bg-center text-white"
  ...
  >
    ...
    <div className="relative z-10 mx-auto flex min-h-screen max-w-5xl flex-col items-center justify-center px-4 py-24 text-center sm:px-6">
      ...
      <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.1 }} className="max-w-4xl text-4xl font-black leading-tight tracking-tight sm:text-5xl md:text-6xl flex flex-wrap justify-center items-center gap-x-2">
        <span>Discover Pakistan&apos;s Finest</span>
        <span className="text-[#e21b70] whitespace-nowrap inline-block text-left min-w-[4.5em] md:min-w-[5em]">
          <Typewriter words={['Flavors', 'Recipes', 'Deals', 'Burgers']} loop={0} cursor cursorStyle="|" typeSpeed={90} deleteSpeed={55} delaySpeed={1600} />
        </span>
        <span className="w-full mt-2">Delivered to Your Doorstep</span>
      </motion.h1>
